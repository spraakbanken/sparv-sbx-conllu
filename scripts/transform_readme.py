...
def main(target: str) -> None:
    ...
    for existing, replacement in [
        (
            "https://img.shields.io/pypi/v/sparv-sbx-conllu.svg",
            f"https://img.shields.io/pypi/v/sparv-sbx-conllu/{version}.svg",
        ),
        (
            "https://img.shields.io/pypi/l/sparv-sbx-conllu.svg",
            f"https://img.shields.io/pypi/l/sparv-sbx-conllu/{version}.svg",
        ),
        (
            "https://img.shields.io/pypi/pyversions/sparv-sbx-conllu.svg",
            f"https://img.shields.io/pypi/pyversions/sparv-sbx-conllu/{version}.svg",
        ),
        (
            "https://img.shields.io/pypi/status/sparv-sbx-conllu.svg",
            f"https://img.shields.io/pypi/status/sparv-sbx-conllu/{version}.svg",
        ),
    ]:
    ...
    def replace(match: re.Match) -> str:
        ...
        if not url.startswith("http"):
            url = urllib.parse.urljoin(
                f"https://github.com/spraakbanken/sparv-sbx-conllu/blob/{version}/README.md",
                url,
            )
        return f"]({url})"
